      ...
      <div className="bg-[#000000] min-h-screen pt-28 pb-20">
        ...
        <section className="px-6 md:px-12 max-w-7xl mx-auto mb-24">
          ...
          >
            ...
            <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-[#FFFFFF] font-light mb-8 tracking-wide leading-[1.1]">
              A Tradition of <br />
            ...
            <p className="font-sans text-sm md:text-base text-[#6E6E6E] leading-relaxed font-light max-w-2xl mx-auto">
              Founded on the principles of timeless craftsmanship and uncompromising quality, Luxe Precision brings you curations that define heritage and sophistication.
            </p>
          </motion.div>
        </section>
        ...
        <section className="px-6 max-w-7xl mx-auto mb-32">
          ...
          >
            <motion.div variants={fadeUp} className="md:col-span-8 relative aspect-[16/9] md:aspect-auto md:h-[500px] overflow-hidden rounded-sm group">
              <img 
                src="https://images.unsplash.com/photo-1607344645866-009c320b63e0?q=80&w=1200" 
        ...
        <section className="px-6 max-w-5xl mx-auto text-center mb-32">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-serif text-[#FFFFFF] leading-[1.3] mb-8">
              "We don't just create garments; we weave stories of heritage, preserving the art of the loom for the modern connoisseur."
            </h2>
